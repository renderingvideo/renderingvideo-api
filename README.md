...
Run `node --test tests/*.test.cjs` for CLI checks. Cross-language API contract checks live in the website repository at `scripts/sdk-contract.test.ts`. Keep the website's `.claude/skills/renderingvideo-api` copy synchronized.
